<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LunchMenu.aspx.cs" Inherits="CU_Canteen.LunchMenu" %>
...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="auto-style1" Height="332px" Width="762px">
        <h2 style="font-size:30px; font-family:'Times New Roman', Times, serif; color:dimgrey" class="auto-style5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lunch Menu</h2>
    <table class="auto-style2">
        ...
        <tr>
    <td class="auto-style11">
        <asp:Button ID="bnInsert" runat="server" Text="Insert" OnClick="btnInsert_Click" Width="80px" />
        <asp:Button ID="bnEdit" runat="server" CssClass="auto-style16" PostBackUrl="~/LunchUpdate.aspx" Text="Edit" Width="80px" style="margin-left: 18px" />
    </td>
    <td class="auto-style4">
        <asp:Button ID="btnDelete" runat="server" CssClass="auto-style15" Text="Delete" Width="80px" style="margin-left: 18px"  PostBackUrl="~/LunchDelete.aspx" />
        <asp:Button ID="btnView" runat="server" CssClass="auto-style17" PostBackUrl="~/selectLunch.aspx" Text="View" Width="80px" style="margin-left: 18px" />
