    ...
    public partial class menu : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (rdr.Read())
            {
                ...
                cell2.Text = "<h2 class='product-title'>" + rdr["Name"].ToString() + "</h2><span class='product-price'>" + rdr["Price"].ToString() + "</span>";
        ...
        protected void buyBtn_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            cmd = new SqlCommand("Insert into BreakfastOrder(Id,Name,qty,Total) values('"+ Session["Id"] + "','" + Name + "','" + Qty + "','" + total + "')", conn);
            cmd.ExecuteNonQuery();
            conn.Close();
