<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SnackReceipt.aspx.cs" Inherits="CU_Canteen.SnackReceipt" %>
...
<!-- ===== ===== Main-Container ===== =====  -->
    <div class="auto-style2" style="padding-right:100px; ">
        ...
        <section class="" style="padding-left:200px;">
             <div class="auto-style1">
                        <center> <asp:Label ID="Label1" runat="server" Text=" Snack Receipt" Font-Bold="True" Font-Size="30px" ForeColor="#FF99CC"></asp:Label></center>

                 <br />
                 <br />
                 <asp:GridView ID="GridView1" runat="server" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Height="144px" Width="276px">
