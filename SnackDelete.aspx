<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SnackDelete.aspx.cs" Inherits="CU_Canteen.SnackDelete" %>
  ...
  <aside id="sidebar-wrapper">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <br />
            <td>
                <asp:Button ID="btnCancel" runat="server" CssClass="auto-style11" Text="Cancel" Width="71px" OnClick="btnCancel_Click" />
            </td>
        </tr>
    </table>
        </div>
