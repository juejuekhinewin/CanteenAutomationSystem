<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LunchUpdate.aspx.cs" Inherits="CU_Canteen.LunchUpdate" %>
  ...
  <aside id="sidebar-wrapper">
    ...
    <tr>
        ...
        <td class="auto-style5">
            ...
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="384px">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>" ProviderName="<%$ ConnectionStrings:ConnectionString3.ProviderName %>" SelectCommand="SELECT * FROM [BreakFast]"></asp:SqlDataSource>
</asp:Panel>
        <br />
       </div>
    </div>
